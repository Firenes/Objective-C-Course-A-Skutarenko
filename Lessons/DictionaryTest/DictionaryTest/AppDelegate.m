...
//                                 nil];
    ...
    NSInteger number = 25;
    // the same too
    NSDictionary *dictionary2 = @{@"lastName": @"Petrov", @"name": @"Vasiliy", @"age": @(number)};
//    NSDictionary *dictionary2 = @{@"lastName": @"Petrov", @"name": @"Vasiliy", @"age": @25};
    
    NSLog(@"%@, \ncount = %lu", dictionary, [dictionary count]);
